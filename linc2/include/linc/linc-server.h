...
#define LINC_SERVER(object)	(LINC_IS_SERVER (object) ? ((GObject*) (object)) : \
				    G_TYPE_CHECK_INSTANCE_CAST ((object), LINC_TYPE_SERVER, LINCServer))

#define LINC_SERVER_CLASS(class)	   (LINC_IS_SERVER_CLASS (class) ? ((GObjectClass*) (class)) : \
				    G_TYPE_CHECK_CLASS_CAST ((class), LINC_TYPE_SERVER, LINCServerClass))

#define LINC_IS_SERVER(object)	   (((GObject*) (object)) != NULL && \
