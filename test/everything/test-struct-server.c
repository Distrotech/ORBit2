...
void
test_StructServer_opFixed__skeleton(ORBitGServant *
					    ...
					    (ORBitGServant * _servant,
					     ...
					     CORBA_Environment * ev))
{
   *(test_FixedLengthStruct *) _o_retval =
      _impl_opFixed(_o_servant, (const test_FixedLengthStruct *) _o_args[0],
		    (test_FixedLengthStruct *) _o_args[1],
		    *(test_FixedLengthStruct * *)_o_args[2], _o_ev);
}

void
test_StructServer_opVariable__skeleton(ORBitGServant *
					       _o_servant, gpointer _o_retval,
					       gpointer * _o_args,
					       CORBA_Context _o_ctx,
					       CORBA_Environment * _o_ev,
						...
						CORBA_Environment * ev))
{
   *(test_VariableLengthStruct * *)_o_retval =
      _impl_opVariable(_o_servant,
		       (const test_VariableLengthStruct *) _o_args[0],
		       (test_VariableLengthStruct *) _o_args[1],
		       (test_VariableLengthStruct **) _o_args[2], _o_ev);
}

void
test_StructServer_opCompound__skeleton(ORBitGServant *
					       _o_servant, gpointer _o_retval,
					       gpointer * _o_args,
					       CORBA_Context _o_ctx,
					       CORBA_Environment * _o_ev,
						...
						CORBA_Environment * ev))
{
   *(test_CompoundStruct * *)_o_retval =
      _impl_opCompound(_o_servant, (const test_CompoundStruct *) _o_args[0],
		       (test_CompoundStruct *) _o_args[1],
		       (test_CompoundStruct **) _o_args[2], _o_ev);
}
...
test_StructServer_opObjectStruct__skeleton(ORBitGServant *
						   ...
						   (ORBitGServant *
						    _servant,
						    const test_ObjectStruct *
						    inArg,
						    CORBA_Environment * ev))
{
   _impl_opObjectStruct(_o_servant, (const test_ObjectStruct *) _o_args[0],
			_o_ev);
}

void
test_StructServer_opStructAny__skeleton(ORBitGServant *
						_o_servant,
						gpointer _o_retval,
						gpointer * _o_args,
						CORBA_Context _o_ctx,
